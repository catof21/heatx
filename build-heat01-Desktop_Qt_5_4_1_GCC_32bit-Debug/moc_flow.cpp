...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_flow_t, stringdata) + ofs \
...
const QMetaObject flow::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_flow.data,
...
void *flow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_flow.stringdata))
